...
class IceCreamMachine:
    ...
    def pick_container(self, choice):
        ...
        try:
            ...
            print(f"\"{choice}\" is not a valid Choice, Choose only from the options below")
    ...
    def pick_flavor(self, choice):
        ...
        try:
            ...
            print(f"\"{choice}\" is not a valid Choice, Choose from the options below")
    ...
    def handle_pay(self, expected, total):
        if total == str(expected):
            ...
            try: 
                ...
                print("Amount entered is not matched with the total. Please re-enter")
                self.run()
    # UCID: mj457
    # Date: 23 Oct 2022
